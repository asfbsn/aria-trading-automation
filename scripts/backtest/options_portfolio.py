...
Vendored from vibe-trading-ai v0.1.12 (https://github.com/HKUDS/Vibe-Trading),
MIT License, Copyright (c) 2026 Vibe-Trading Contributors. See LICENSE in this
directory for the full license text. Trimmed to drop the run_card.py dependency
(not needed here — we consume metrics.csv/trades.csv directly); otherwise
unmodified.
